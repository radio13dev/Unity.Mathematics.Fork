...
public struct LocalTransform : IComponentData
{
    ...
    /// </summary>
    public static readonly LocalTransform Identity = new LocalTransform { Scale = fp._1, Rotation = quaternion.identity };
    ...
    public static LocalTransform FromMatrixSafe(float4x4 matrix)
    {
        ...
        var dot01 = math.dot(matrix3x3.c0, matrix3x3.c1);
        var dot02 = math.dot(matrix3x3.c0, matrix3x3.c2);
        var dot12 = math.dot(matrix3x3.c1, matrix3x3.c2);
    ...
    /// <returns>The Transform.</returns>
    public static LocalTransform FromPositionRotation(float3 position, quaternion rotation) => new() {Position = position, Scale = fp._1, Rotation = rotation};
    ...
    /// <returns>The Transform.</returns>
    public static LocalTransform FromPositionRotationScale(float3 position, quaternion rotation, fp scale) => new() {Position = position, Scale = scale, Rotation = rotation};
    ...
    /// <param name="position">The position.</param>
    /// <returns>The Transform.</returns>
    public static LocalTransform FromPosition(float3 position) => new() {Position = position, Scale = fp._1, Rotation = quaternion.identity};
    ...
    /// <returns>The Transform.</returns>
    public static LocalTransform FromPosition(fp x, fp y, fp z) => new() {Position = new float3(x,y,z), Scale = fp._1, Rotation = quaternion.identity};
    ...
    /// <param name="rotation">The rotation.</param>
    /// <returns>The Transform.</returns>
    public static LocalTransform FromRotation(quaternion rotation) => new() {Position = float3.zero, Scale = fp._1, Rotation = rotation};
    ...
    /// <param name="scale">The scale.</param>
    /// <returns>The Transform.</returns>
    public static LocalTransform FromScale(fp scale) => new() {Position = float3.zero, Scale = scale, Rotation = quaternion.identity};
    ...
    public fp TransformScale(fp scale) => scale * Scale;
    ...
    /// <param name="scale">The scale to be transformed.</param>
    /// <returns>The scale after transformation.</returns>
    public fp InverseTransformScale(fp scale) => scale / Scale;
    ...
    public LocalTransform WithPosition(fp x, fp y, fp z) => new() { Position = new float3(x,y,z), Scale = Scale, Rotation = Rotation };
    ...
    public LocalTransform WithScale(fp scale) => new() { Position = Position, Scale = scale, Rotation = Rotation };
    ...
    public LocalTransform ApplyScale(fp scale) => new() { Position = Position, Scale = Scale * scale, Rotation = Rotation};
    ...
    /// <returns>A new, rotated Transform.</returns>
    public LocalTransform RotateX(fp angle) => Rotate(quaternion.RotateX(angle));
    ...
    /// <returns>A new, rotated Transform.</returns>
    public LocalTransform RotateY(fp angle) => Rotate(quaternion.RotateY(angle));
    ...
    /// <returns>A new, rotated Transform.</returns>
    public LocalTransform RotateZ(fp angle) => Rotate(quaternion.RotateZ(angle));
