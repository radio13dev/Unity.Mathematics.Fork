...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct uint2x4 : System.IEquatable<uint2x4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint2x4 matrix from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint2x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint2x4(fp v)
        {
            this.c0 = (uint2)v;
        ...
        /// <summary>Explicitly converts a single fp value to a uint2x4 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint2x4(fp v) { return new uint2x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint2x4 matrix constructed from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2x4 uint2x4(fp v) { return new uint2x4(v); }
