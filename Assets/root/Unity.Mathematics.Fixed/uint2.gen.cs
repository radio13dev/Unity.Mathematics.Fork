...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct uint2 : System.IEquatable<uint2>, IFormattable
    {
        ...
        /// <summary>Constructs a uint2 vector from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint2(fp v)
        {
            this.x = (uint)v;
        ...
        /// <summary>Explicitly converts a single fp value to a uint2 vector by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint2(fp v) { return new uint2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint2 vector constructed from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2 uint2(fp v) { return new uint2(v); }
