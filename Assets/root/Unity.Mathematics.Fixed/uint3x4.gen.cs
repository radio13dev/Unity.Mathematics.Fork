...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct uint3x4 : System.IEquatable<uint3x4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint3x4 matrix from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint3x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint3x4(fp v)
        {
            this.c0 = (uint3)v;
        ...
        /// <summary>Explicitly converts a single fp value to a uint3x4 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3x4(fp v) { return new uint3x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint3x4 matrix constructed from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint3x4 uint3x4(fp v) { return new uint3x4(v); }
