...
namespace Unity.Mathematics.Fixed
{
    ...
    public struct RigidTransform
    {
        ...
        public static readonly RigidTransform identity = new RigidTransform(new quaternion(fp._0, fp._0, fp._0, fp._1), new float3(fp._0, fp._0, fp._0));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform AxisAngle(float3 axis, fp angle) { return new RigidTransform(quaternion.AxisAngle(axis, angle), float3.zero); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerXYZ(fp x, fp y, fp z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerXZY(fp x, fp y, fp z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerYXZ(fp x, fp y, fp z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerYZX(fp x, fp y, fp z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerZXY(fp x, fp y, fp z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The RigidTransform of the Euler angle transformation in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RigidTransform EulerZYX(fp x, fp y, fp z) { return EulerZYX(float3(x, y, z)); }
