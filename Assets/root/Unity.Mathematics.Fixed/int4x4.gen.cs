...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct int4x4 : System.IEquatable<int4x4>, IFormattable
    {
        ...
        /// <summary>Constructs a int4x4 matrix from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4x4(fp v)
        {
            this.c0 = (int4)v;
        ...
        /// <summary>Explicitly converts a single fp value to a int4x4 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x4(fp v) { return new int4x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int4x4 matrix constructed from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4x4 int4x4(fp v) { return new int4x4(v); }
