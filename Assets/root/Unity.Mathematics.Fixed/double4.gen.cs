...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct double4 : System.IEquatable<double4>, IFormattable
    {
        ...
        /// <summary>Constructs a double4 vector from a single fp value by converting it to double and assigning it to every component.</summary>
        /// <param name="v">fp to convert to double4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double4(fp v)
        {
            this.x = (double)v;
        ...
        /// <summary>Implicitly converts a single fp value to a double4 vector by converting it to double and assigning it to every component.</summary>
        /// <param name="v">fp to convert to double4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4(fp v) { return new double4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double4 vector constructed from a single fp value by converting it to double and assigning it to every component.</summary>
        /// <param name="v">fp to convert to double4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4 double4(fp v) { return new double4(v); }
