...
namespace Unity.Mathematics.Fixed
{
    public static partial class noise
    {
        ...
        public static fp cnoise(float4 P)
        {
            float4 Pi0 = floor(P); // Integer part for indexing
            float4 Pi1 = Pi0 + fp._1; // Integer part + 1
            Pi0 = mod289(Pi0);
            Pi1 = mod289(Pi1);
            float4 Pf0 = frac(P); // Fractional part for interpolation
            float4 Pf1 = Pf0 - fp._1; // Fractional part - 1.0
            ...
            float4 gx00 = ixy00 * (fp._1 / fp._7);
            float4 gy00 = floor(gx00) * (fp._1 / fp._7);
            float4 gz00 = floor(gy00) * (fp._1 / fp._6);
            gx00 = frac(gx00) - fp._0_50;
            gy00 = frac(gy00) - fp._0_50;
            gz00 = frac(gz00) - fp._0_50;
            float4 gw00 = float4(0.75f) - abs(gx00) - abs(gy00) - abs(gz00);
            float4 sw00 = step(gw00, float4(fp._0));
            gx00 -= sw00 * (step(fp._0, gx00) - fp._0_50);
            gy00 -= sw00 * (step(fp._0, gy00) - fp._0_50);

            float4 gx01 = ixy01 * (fp._1 / fp._7);
            float4 gy01 = floor(gx01) * (fp._1 / fp._7);
            float4 gz01 = floor(gy01) * (fp._1 / fp._6);
            gx01 = frac(gx01) - fp._0_50;
            gy01 = frac(gy01) - fp._0_50;
            gz01 = frac(gz01) - fp._0_50;
            float4 gw01 = float4(0.75f) - abs(gx01) - abs(gy01) - abs(gz01);
            float4 sw01 = step(gw01, float4(fp._0));
            gx01 -= sw01 * (step(fp._0, gx01) - fp._0_50);
            gy01 -= sw01 * (step(fp._0, gy01) - fp._0_50);

            float4 gx10 = ixy10 * (fp._1 / fp._7);
            float4 gy10 = floor(gx10) * (fp._1 / fp._7);
            float4 gz10 = floor(gy10) * (fp._1 / fp._6);
            gx10 = frac(gx10) - fp._0_50;
            gy10 = frac(gy10) - fp._0_50;
            gz10 = frac(gz10) - fp._0_50;
            float4 gw10 = float4(0.75f) - abs(gx10) - abs(gy10) - abs(gz10);
            float4 sw10 = step(gw10, float4(fp._0));
            gx10 -= sw10 * (step(fp._0, gx10) - fp._0_50);
            gy10 -= sw10 * (step(fp._0, gy10) - fp._0_50);

            float4 gx11 = ixy11 * (fp._1 / fp._7);
            float4 gy11 = floor(gx11) * (fp._1 / fp._7);
            float4 gz11 = floor(gy11) * (fp._1 / fp._6);
            gx11 = frac(gx11) - fp._0_50;
            gy11 = frac(gy11) - fp._0_50;
            gz11 = frac(gz11) - fp._0_50;
            float4 gw11 = float4(0.75f) - abs(gx11) - abs(gy11) - abs(gz11);
            float4 sw11 = step(gw11, float4(fp._0));
            gx11 -= sw11 * (step(fp._0, gx11) - fp._0_50);
            gy11 -= sw11 * (step(fp._0, gy11) - fp._0_50);
            ...
            fp n0000 = dot(g0000, Pf0);
            fp n1000 = dot(g1000, float4(Pf1.x, Pf0.yzw));
            fp n0100 = dot(g0100, float4(Pf0.x, Pf1.y, Pf0.zw));
            fp n1100 = dot(g1100, float4(Pf1.xy, Pf0.zw));
            fp n0010 = dot(g0010, float4(Pf0.xy, Pf1.z, Pf0.w));
            fp n1010 = dot(g1010, float4(Pf1.x, Pf0.y, Pf1.z, Pf0.w));
            fp n0110 = dot(g0110, float4(Pf0.x, Pf1.yz, Pf0.w));
            fp n1110 = dot(g1110, float4(Pf1.xyz, Pf0.w));
            fp n0001 = dot(g0001, float4(Pf0.xyz, Pf1.w));
            fp n1001 = dot(g1001, float4(Pf1.x, Pf0.yz, Pf1.w));
            fp n0101 = dot(g0101, float4(Pf0.x, Pf1.y, Pf0.z, Pf1.w));
            fp n1101 = dot(g1101, float4(Pf1.xy, Pf0.z, Pf1.w));
            fp n0011 = dot(g0011, float4(Pf0.xy, Pf1.zw));
            fp n1011 = dot(g1011, float4(Pf1.x, Pf0.y, Pf1.zw));
            fp n0111 = dot(g0111, float4(Pf0.x, Pf1.yzw));
            fp n1111 = dot(g1111, Pf1);
            ...
            fp n_xyzw = lerp(n_yzw.x, n_yzw.y, fade_xyzw.x);
            return fp._2_2 * n_xyzw;
        }
        ...
        /// <returns>Noise value.</returns>
        public static fp pnoise(float4 P, float4 rep)
        {
            float4 Pi0 = fmod(floor(P), rep); // Integer part math.modulo rep
            float4 Pi1 = fmod(Pi0 + fp._1, rep); // Integer part + 1 math.mod rep
            Pi0 = mod289(Pi0);
            Pi1 = mod289(Pi1);
            float4 Pf0 = frac(P); // Fractional part for interpolation
            float4 Pf1 = Pf0 - fp._1; // Fractional part - 1.0
