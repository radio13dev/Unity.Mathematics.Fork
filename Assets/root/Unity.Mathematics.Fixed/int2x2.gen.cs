...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct int2x2 : System.IEquatable<int2x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x2 matrix from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x2(fp v)
        {
            this.c0 = (int2)v;
        ...
        /// <summary>Explicitly converts a single fp value to a int2x2 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x2(fp v) { return new int2x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int2x2 matrix constructed from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x2 int2x2(fp v) { return new int2x2(v); }
