...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct uint3 : System.IEquatable<uint3>, IFormattable
    {
        ...
        /// <summary>Constructs a uint3 vector from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint3(fp v)
        {
            this.x = (uint)v;
        ...
        /// <summary>Explicitly converts a single fp value to a uint3 vector by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(fp v) { return new uint3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint3 vector constructed from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint3 uint3(fp v) { return new uint3(v); }
