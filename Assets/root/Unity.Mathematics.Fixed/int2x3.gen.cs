...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct int2x3 : System.IEquatable<int2x3>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x3 matrix from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int2x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x3(fp v)
        {
            this.c0 = (int2)v;
        ...
        /// <summary>Explicitly converts a single fp value to a int2x3 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x3(fp v) { return new int2x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int2x3 matrix constructed from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x3 int2x3(fp v) { return new int2x3(v); }
