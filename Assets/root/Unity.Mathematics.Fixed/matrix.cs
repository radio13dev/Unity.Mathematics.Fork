...
namespace Unity.Mathematics.Fixed
{
    public partial struct float2x2
    {
        ...
        public static float2x2 Rotate(fp angle)
        {
            fp s, c;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x2 Scale(fp s)
        {
            return float2x2(s,    fp._0,
                            fp._0, s);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x2 Scale(fp x, fp y)
        {
            return float2x2(x,    fp._0,
                            fp._0, y);
        }
    ...
    public partial struct float3x3
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 AxisAngle(float3 axis, fp angle)
        {
            fp sina, cosa;
            ...
            /*
            return float3x3(
                cosa + u.x * u.x * (fp._1 - cosa),       u.y * u.x * (fp._1 - cosa) - u.z * sina, u.z * u.x * (fp._1 - cosa) + u.y * sina,
                u.x * u.y * (fp._1 - cosa) + u.z * sina, cosa + u.y * u.y * (fp._1 - cosa),       u.y * u.z * (fp._1 - cosa) - u.x * sina,
                u.x * u.z * (fp._1 - cosa) - u.y * sina, u.y * u.z * (fp._1 - cosa) + u.x * sina, cosa + u.z * u.z * (fp._1 - cosa)
                );
                */
        }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerXYZ(fp x, fp y, fp z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerXZY(fp x, fp y, fp z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerYXZ(fp x, fp y, fp z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerYZX(fp x, fp y, fp z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerZXY(fp x, fp y, fp z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 EulerZYX(fp x, fp y, fp z) { return EulerZYX(float3(x, y, z)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 RotateX(fp angle)
        {
            // {{1, 0, 0}, {0, c_0, -s_0}, {0, s_0, c_0}}
            fp s, c;
            sincos(angle, out s, out c);
            return float3x3(fp._1, fp._0, fp._0,
                            fp._0, c,    -s,
                            fp._0, s,    c);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 RotateY(fp angle)
        {
            // {{c_1, 0, s_1}, {0, 1, 0}, {-s_1, 0, c_1}}
            fp s, c;
            sincos(angle, out s, out c);
            return float3x3(c,    fp._0, s,
                            fp._0, fp._1, fp._0,
                            -s,   fp._0, c);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 RotateZ(fp angle)
        {
            // {{c_2, -s_2, 0}, {s_2, c_2, 0}, {0, 0, 1}}
            fp s, c;
            sincos(angle, out s, out c);
            return float3x3(c,    -s,   fp._0,
                            s,    c,    fp._0,
                            fp._0, fp._0, fp._1);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 Scale(fp s)
        {
            return float3x3(s,    fp._0, fp._0,
                            fp._0, s,    fp._0,
                            fp._0, fp._0, s);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 Scale(fp x, fp y, fp z)
        {
            return float3x3(x,    fp._0, fp._0,
                            fp._0, y,    fp._0,
                            fp._0, fp._0, z);
        }
    ...
    public partial struct float4x4
    {
        ...
        {
            c0 = float4(rotation.c0, fp._0);
            c1 = float4(rotation.c1, fp._0);
            c2 = float4(rotation.c2, fp._0);
            c3 = float4(translation, fp._1);
        }
        ...
        public float4x4(quaternion rotation, float3 translation)
        {
            ...
            c0 = float4(rot.c0, fp._0);
            c1 = float4(rot.c1, fp._0);
            c2 = float4(rot.c2, fp._0);
            c3 = float4(translation, fp._1);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 AxisAngle(float3 axis, fp angle)
        {
            fp sina, cosa;
            math.sincos(angle, out sina, out cosa);

            float4 u = float4(axis, fp._0);
            float4 u_yzx = u.yzxx;
            float4 u_zxy = u.zxyx;
        ...
        public static float4x4 EulerXYZ(float3 xyz)
        {
            ...
            sincos(xyz, out s, out c);
            return float4x4(
                c.y * c.z,  c.z * s.x * s.y - c.x * s.z,    c.x * c.z * s.y + s.x * s.z,    fp._0,
                c.y * s.z,  c.x * c.z + s.x * s.y * s.z,    c.x * s.y * s.z - c.z * s.x,    fp._0,
                -s.y,       c.y * s.x,                      c.x * c.y,                      fp._0,
                fp._0,       fp._0,                           fp._0,                           fp._1
                );
        }
        ...
        public static float4x4 EulerXZY(float3 xyz)
        {
            ...
            sincos(xyz, out s, out c);
            return float4x4(
                c.y * c.z,  s.x * s.y - c.x * c.y * s.z,    c.x * s.y + c.y * s.x * s.z,    fp._0,
                s.z,        c.x * c.z,                      -c.z * s.x,                     fp._0,
                -c.z * s.y, c.y * s.x + c.x * s.y * s.z,    c.x * c.y - s.x * s.y * s.z,    fp._0,
                fp._0,       fp._0,                           fp._0,                           fp._1
                );
        }
        ...
        public static float4x4 EulerYXZ(float3 xyz)
        {
            ...
            sincos(xyz, out s, out c);
            return float4x4(
                c.y * c.z - s.x * s.y * s.z,    -c.x * s.z, c.z * s.y + c.y * s.x * s.z,    fp._0,
                c.z * s.x * s.y + c.y * s.z,    c.x * c.z,  s.y * s.z - c.y * c.z * s.x,    fp._0,
                -c.x * s.y,                     s.x,        c.x * c.y,                      fp._0,
                fp._0,                           fp._0,       fp._0,                           fp._1
                );
        }
        ...
        public static float4x4 EulerYZX(float3 xyz)
        {
            ...
            sincos(xyz, out s, out c);
            return float4x4(
                c.y * c.z,                      -s.z,       c.z * s.y,                      fp._0,
                s.x * s.y + c.x * c.y * s.z,    c.x * c.z,  c.x * s.y * s.z - c.y * s.x,    fp._0,
                c.y * s.x * s.z - c.x * s.y,    c.z * s.x,  c.x * c.y + s.x * s.y * s.z,    fp._0,
                fp._0,                           fp._0,       fp._0,                           fp._1
                );
        }
        ...
        public static float4x4 EulerZXY(float3 xyz)
        {
            ...
            sincos(xyz, out s, out c);
            return float4x4(
                c.y * c.z + s.x * s.y * s.z,    c.z * s.x * s.y - c.y * s.z,    c.x * s.y,  fp._0,
                c.x * s.z,                      c.x * c.z,                      -s.x,       fp._0,
                c.y * s.x * s.z - c.z * s.y,    c.y * c.z * s.x + s.y * s.z,    c.x * c.y,  fp._0,
                fp._0,                           fp._0,                           fp._0,       fp._1
                );
        }
        ...
        public static float4x4 EulerZYX(float3 xyz)
        {
            ...
            sincos(xyz, out s, out c);
            return float4x4(
                c.y * c.z,                      -c.y * s.z,                     s.y,        fp._0,
                c.z * s.x * s.y + c.x * s.z,    c.x * c.z - s.x * s.y * s.z,    -c.y * s.x, fp._0,
                s.x * s.z - c.x * c.z * s.y,    c.z * s.x + c.x * s.y * s.z,    c.x * c.y,  fp._0,
                fp._0,                           fp._0,                           fp._0,       fp._1
                );
        }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerXYZ(fp x, fp y, fp z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerXZY(fp x, fp y, fp z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerYXZ(fp x, fp y, fp z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerYZX(fp x, fp y, fp z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerZXY(fp x, fp y, fp z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 EulerZYX(fp x, fp y, fp z) { return EulerZYX(float3(x, y, z)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 RotateX(fp angle)
        {
            // {{1, 0, 0}, {0, c_0, -s_0}, {0, s_0, c_0}}
            fp s, c;
            sincos(angle, out s, out c);
            return float4x4(fp._1, fp._0, fp._0, fp._0,
                            fp._0, c,    -s,   fp._0,
                            fp._0, s,    c,    fp._0,
                            fp._0, fp._0, fp._0, fp._1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 RotateY(fp angle)
        {
            // {{c_1, 0, s_1}, {0, 1, 0}, {-s_1, 0, c_1}}
            fp s, c;
            sincos(angle, out s, out c);
            return float4x4(c,    fp._0, s,    fp._0,
                            fp._0, fp._1, fp._0, fp._0,
                            -s,   fp._0, c,    fp._0,
                            fp._0, fp._0, fp._0, fp._1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 RotateZ(fp angle)
        {
            // {{c_2, -s_2, 0}, {s_2, c_2, 0}, {0, 0, 1}}
            fp s, c;
            sincos(angle, out s, out c);
            return float4x4(c,    -s,   fp._0, fp._0,
                            s,    c,    fp._0, fp._0,
                            fp._0, fp._0, fp._1, fp._0,
                            fp._0, fp._0, fp._0, fp._1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Scale(fp s)
        {
            return float4x4(s,    fp._0, fp._0, fp._0,
                            fp._0, s,    fp._0, fp._0,
                            fp._0, fp._0, s,    fp._0,
                            fp._0, fp._0, fp._0, fp._1);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Scale(fp x, fp y, fp z)
        {
            return float4x4(x,    fp._0, fp._0, fp._0,
                            fp._0, y,    fp._0, fp._0,
                            fp._0, fp._0, z,    fp._0,
                            fp._0, fp._0, fp._0, fp._1);
        }
        ...
        {
            return float4x4(float4(fp._1, fp._0, fp._0, fp._0),
                            float4(fp._0, fp._1, fp._0, fp._0),
                            float4(fp._0, fp._0, fp._1, fp._0),
                            float4(vector.x, vector.y, vector.z, fp._1));
        }
        ...
        public static float4x4 LookAt(float3 eye, float3 target, float3 up)
        {
            ...
            float4x4 matrix;
            matrix.c0 = float4(rot.c0, fp._0);
            matrix.c1 = float4(rot.c1, fp._0);
            matrix.c2 = float4(rot.c2, fp._0);
            matrix.c3 = float4(eye, fp._1);
            return matrix;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 Ortho(fp width, fp height, fp near, fp far)
        {
            fp rcpdx = fp._1 / width;
            fp rcpdy = fp._1 / height;
            fp rcpdz = fp._1 / (far - near);

            return float4x4(
                fp._2 * rcpdx,   fp._0,            fp._0,           fp._0,
                fp._0,           fp._2 * rcpdy,    fp._0,           fp._0,
                fp._0,           fp._0,           -fp._2 * rcpdz,  -(far + near) * rcpdz,
                fp._0,           fp._0,            fp._0,           fp._1
                );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 OrthoOffCenter(fp left, fp right, fp bottom, fp top, fp near, fp far)
        {
            fp rcpdx = fp._1 / (right - left);
            fp rcpdy = fp._1 / (top - bottom);
            fp rcpdz = fp._1 / (far - near);

            return float4x4(
                fp._2 * rcpdx,   fp._0,           fp._0,               -(right + left) * rcpdx,
                fp._0,           fp._2 * rcpdy,   fp._0,               -(top + bottom) * rcpdy,
                fp._0,           fp._0,          -fp._2 * rcpdz,       -(far + near) * rcpdz,
                fp._0,           fp._0,           fp._0,                fp._1
                );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 PerspectiveFov(fp verticalFov, fp aspect, fp near, fp far)
        {
            fp cotangent = fp._1 / tan(verticalFov * fp._0_50);
            fp rcpdz = fp._1 / (near - far);

            return float4x4(
                cotangent / aspect, fp._0,       fp._0,                   fp._0,
                fp._0,               cotangent,  fp._0,                   fp._0,
                fp._0,               fp._0,       (far + near) * rcpdz,   fp._2 * near * far * rcpdz,
                fp._0,               fp._0,      -fp._1,                   fp._0
                );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 PerspectiveOffCenter(fp left, fp right, fp bottom, fp top, fp near, fp far)
        {
            fp rcpdz = fp._1 / (near - far);
            fp rcpWidth = fp._1 / (right - left);
            fp rcpHeight = fp._1 / (top - bottom);

            return float4x4(
                fp._2 * near * rcpWidth,     fp._0,                       (left + right) * rcpWidth,     fp._0,
                fp._0,                       fp._2 * near * rcpHeight,    (bottom + top) * rcpHeight,    fp._0,
                fp._0,                       fp._0,                        (far + near) * rcpdz,          fp._2 * near * far * rcpdz,
                fp._0,                       fp._0,                       -fp._1,                          fp._0
                );
        }
        ...
        public static float4x4 TRS(float3 translation, quaternion rotation, float3 scale)
        {
            ...
            return float4x4(  float4(r.c0 * scale.x, fp._0),
                              float4(r.c1 * scale.y, fp._0),
                              float4(r.c2 * scale.z, fp._0),
                              float4(translation, fp._1));
        }
    }
    ...
    partial class math
    {
        ...
        /// </summary>
        /// <param name="f4x4"><see cref="Fixed.float4x4"/> to extract a float3x3 from.</param>
        ...
        public static float3x3 orthonormalize(float3x3 i)
        {
            ...
            fp lenU = math.length(u);
            fp lenV = math.length(v);

            bool c = lenU > fp.epsilon && lenV > fp.epsilon;
        ...
        {
            fp scaleSq = fp._1div3 * (math.lengthsq(m.c0) + math.lengthsq(m.c1) + math.lengthsq(m.c2));
            if (scaleSq < svd.k_EpsilonNormal)
                return Mathematics.Fixed.float3x3.zero;
