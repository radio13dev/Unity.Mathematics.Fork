...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct float4x4 : System.IEquatable<float4x4>, IFormattable
    {
        ...
        public static readonly float4x4 identity = new float4x4(fp._1, fp._0, fp._0, fp._0,   fp._0, fp._1, fp._0, fp._0,   fp._0, fp._0, fp._1, fp._0,   fp._0, fp._0, fp._0, fp._1);
        ...
        /// <summary>Constructs a float4x4 matrix from 16 fp values given in row-major order.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float4x4(fp m00, fp m01, fp m02, fp m03,
        ...
        /// <summary>Constructs a float4x4 matrix from a single fp value by assigning it to every component.</summary>
        /// <param name="v">fp to convert to float4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float4x4(fp v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Constructs a float4x4 matrix from a single bool value by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float4x4(bool v)
        {
            this.c0 = math.select(new float4(fp._0), new float4(fp._1), v);
            this.c1 = math.select(new float4(fp._0), new float4(fp._1), v);
            this.c2 = math.select(new float4(fp._0), new float4(fp._1), v);
            this.c3 = math.select(new float4(fp._0), new float4(fp._1), v);
        }
        ...
        {
            this.c0 = math.select(new float4(fp._0), new float4(fp._1), v.c0);
            this.c1 = math.select(new float4(fp._0), new float4(fp._1), v.c1);
            this.c2 = math.select(new float4(fp._0), new float4(fp._1), v.c2);
            this.c3 = math.select(new float4(fp._0), new float4(fp._1), v.c3);
        }

        /// <summary>Constructs a float4x4 matrix from a single int value by converting it to fp and assigning it to every component.</summary>
        ...
        /// <summary>Constructs a float4x4 matrix from a single uint value by converting it to fp and assigning it to every component.</summary>
        ...
        /// <summary>Constructs a float4x4 matrix from a single double value by converting it to fp and assigning it to every component.</summary>
        ...
        /// <summary>Implicitly converts a single fp value to a float4x4 matrix by assigning it to every component.</summary>
        /// <param name="v">fp to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float4x4(fp v) { return new float4x4(v); }

        /// <summary>Explicitly converts a single bool value to a float4x4 matrix by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a single int value to a float4x4 matrix by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">int to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a single uint value to a float4x4 matrix by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">uint to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Explicitly converts a single double value to a float4x4 matrix by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">double to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns the result of a componentwise multiplication operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise multiplication.</param>
        /// <param name="rhs">Right hand side fp to use to compute componentwise multiplication.</param>
        /// <returns>float4x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 operator * (float4x4 lhs, fp rhs) { return new float4x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a fp value and a float4x4 matrix.</summary>
        /// <param name="lhs">Left hand side fp to use to compute componentwise multiplication.</param>
        /// <param name="rhs">Right hand side float4x4 to use to compute componentwise multiplication.</param>
        /// <returns>float4x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 operator * (fp lhs, float4x4 rhs) { return new float4x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        /// <summary>Returns the result of a componentwise addition operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise addition.</param>
        ...
        /// <summary>Returns the result of a componentwise addition operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise subtraction operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise subtraction.</param>
        ...
        /// <summary>Returns the result of a componentwise subtraction operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise division operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise division.</param>
        ...
        /// <summary>Returns the result of a componentwise division operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise modulus operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise modulus.</param>
        ...
        /// <summary>Returns the result of a componentwise modulus operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise less than operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise less than.</param>
        /// <param name="rhs">Right hand side fp to use to compute componentwise less than.</param>
        /// <returns>bool4x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x4 operator < (float4x4 lhs, fp rhs) { return new bool4x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a fp value and a float4x4 matrix.</summary>
        /// <param name="lhs">Left hand side fp to use to compute componentwise less than.</param>
        /// <param name="rhs">Right hand side float4x4 to use to compute componentwise less than.</param>
        /// <returns>bool4x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x4 operator < (fp lhs, float4x4 rhs) { return new bool4x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
        ...
        /// <summary>Returns the result of a componentwise less or equal operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise less or equal.</param>
        ...
        /// <summary>Returns the result of a componentwise less or equal operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise greater than operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise greater than.</param>
        ...
        /// <summary>Returns the result of a componentwise greater than operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise greater or equal operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise greater or equal.</param>
        ...
        /// <summary>Returns the result of a componentwise greater or equal operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise equality operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise equality.</param>
        ...
        /// <summary>Returns the result of a componentwise equality operation on a fp value and a float4x4 matrix.</summary>
        ...
        /// <summary>Returns the result of a componentwise not equal operation on a float4x4 matrix and a fp value.</summary>
        /// <param name="lhs">Left hand side float4x4 to use to compute componentwise not equal.</param>
        ...
        /// <summary>Returns the result of a componentwise not equal operation on a fp value and a float4x4 matrix.</summary>
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a float4x4 matrix constructed from from 16 fp values given in row-major order.</summary>
        /// <param name="m00">The matrix at row 0, column 0 will be set to this value.</param>
        /// <param name="m01">The matrix at row 0, column 1 will be set to this value.</param>
        /// <param name="m02">The matrix at row 0, column 2 will be set to this value.</param>
        /// <param name="m03">The matrix at row 0, column 3 will be set to this value.</param>
        ...
        /// <returns>float4x4 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 float4x4(fp m00, fp m01, fp m02, fp m03,
                                        fp m10, fp m11, fp m12, fp m13,
                                        fp m20, fp m21, fp m22, fp m23,
                                        fp m30, fp m31, fp m32, fp m33)
        {
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single fp value by assigning it to every component.</summary>
        /// <param name="v">fp to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 float4x4(fp v) { return new float4x4(v); }

        /// <summary>Returns a float4x4 matrix constructed from a single bool value by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">bool to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single int value by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">int to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single uint value by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">uint to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a float4x4 matrix constructed from a single double value by converting it to fp and assigning it to every component.</summary>
        /// <param name="v">double to convert to float4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public static float4x4 inverse(float4x4 m)
        {
            ...
            float4 rcp_denom_ppnn = float4(fp._1) / denom;
            float4x4 res;
        ...
        public static fp determinant(float4x4 m)
        {
            float4 c0 = m.c0;
            float4 c1 = m.c1;
            float4 c2 = m.c2;
        ...
        {
            return unchecked(csum(uint4(asulong_unsafe(v.c0) * ulong4(hash_02, hash_01, hash_04, hash_13) +
                        asulong_unsafe(v.c1) * ulong4(hash_05, hash_15, hash_14, hash_03) +
                        asulong_unsafe(v.c2) * ulong4(hash_06, hash_07, hash_09, hash_08) +
                        asulong_unsafe(v.c3) * ulong4(hash_10, hash_12, hash_11, hash_16))) + (uint)hash_17);
        }
        ...
        {
            return unchecked(uint4(asulong_unsafe(v.c0) * ulong4(hash_17, hash_16, hash_14, hash_15) +
                    asulong_unsafe(v.c1) * ulong4(hash_02, hash_13, hash_11, hash_12) +
                    asulong_unsafe(v.c2) * ulong4(hash_04, hash_03, hash_01, hash_05) +
                    asulong_unsafe(v.c3) * ulong4(hash_07, hash_08, hash_06, hash_09)) + (uint)hash_10);
        }
