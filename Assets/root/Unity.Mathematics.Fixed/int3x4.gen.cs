...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct int3x4 : System.IEquatable<int3x4>, IFormattable
    {
        ...
        /// <summary>Constructs a int3x4 matrix from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int3x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int3x4(fp v)
        {
            this.c0 = (int3)v;
        ...
        /// <summary>Explicitly converts a single fp value to a int3x4 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int3x4(fp v) { return new int3x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int3x4 matrix constructed from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3x4 int3x4(fp v) { return new int3x4(v); }
