...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct Random
    {
        ...
        public fp NextFloat()
        {
            return asfloat(0x3f800000 | (NextState() >> 9)) - fp._1;
        }
        ...
        {
            return asfloat(0x3f800000 | (uint2(NextState(), NextState()) >> 9)) - fp._1;
        }
        ...
        {
            return asfloat(0x3f800000 | (uint3(NextState(), NextState(), NextState()) >> 9)) - fp._1;
        }
        ...
        {
            return asfloat(0x3f800000 | (uint4(NextState(), NextState(), NextState(), NextState()) >> 9)) - fp._1;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp NextFloat(fp max) { return NextFloat() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp NextFloat(fp min, fp max) { return NextFloat() * (max - min) + min; }
        ...
        public quaternion NextQuaternionRotation()
        {
            ...
            return quaternion(select(q.value, -q.value, q.value.w < fp._0));
        }
