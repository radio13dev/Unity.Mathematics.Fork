...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct int4x2 : System.IEquatable<int4x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int4x2 matrix from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int4x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4x2(fp v)
        {
            this.c0 = (int4)v;
        ...
        /// <summary>Explicitly converts a single fp value to a int4x2 matrix by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x2(fp v) { return new int4x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a int4x2 matrix constructed from a single fp value by converting it to int and assigning it to every component.</summary>
        /// <param name="v">fp to convert to int4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4x2 int4x2(fp v) { return new int4x2(v); }
