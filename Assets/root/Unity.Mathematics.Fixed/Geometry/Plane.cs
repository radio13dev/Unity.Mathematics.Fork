...
namespace Unity.Mathematics.Fixed.Geometry
{
    ...
    public struct Plane
    {
        ...
        public Plane(fp coefficientA, fp coefficientB, fp coefficientC, fp coefficientD)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Plane(float3 normal, fp distance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plane CreateFromUnitNormalAndDistance(float3 unitNormal, fp distance)
        {
        ...
        {
            fp recipLength = math.rsqrt(math.lengthsq(planeCoefficients.xyz));
        ...
        /// Avoid comparing equality with fp._0 when testing if a point lies exactly in the plane and use an approximate
        /// comparison instead.
        /// </remarks>
        /// <param name="point">Point to find the signed distance with.</param>
        /// <returns>Signed distance of the point from the plane.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp SignedDistanceToPoint(float3 point)
        {
            CheckPlaneIsNormalized();
            return math.dot(NormalAndDistance, new float4(point, fp._1));
        }
        ...
        static readonly fp lowerBound = fp._0_999*fp._0_999;
        static readonly fp upperBound = fp._1_001*fp._1_001;

        [Conditional("ENABLE_UNITY_COLLECTIONS_CHECKS")]
        void CheckPlaneIsNormalized()
        {
            fp ll = math.lengthsq(Normal.xyz);
