...
namespace Unity.Mathematics.Fixed.Geometry
{
    ...
    public struct MinMaxAABB : IEquatable<MinMaxAABB>
    {
        ...
        {
            return CreateFromCenterAndHalfExtents(center, extents * fp._0_50);
        }
        ...
        /// </remarks>
        public float3 HalfExtents => (Max - Min) * fp._0_50;

        /// <summary>
        /// Computes the center of the AABB.
        /// </summary>
        public float3 Center => (Max + Min) * fp._0_50;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Expand(fp signedDistance)
        {
            Min -= signedDistance;
            Max += signedDistance;
        }
