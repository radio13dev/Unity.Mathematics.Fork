...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct double3 : System.IEquatable<double3>, IFormattable
    {
        ...
        /// <summary>Constructs a double3 vector from a single fp value by converting it to double and assigning it to every component.</summary>
        /// <param name="v">fp to convert to double3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double3(fp v)
        {
            this.x = (double)v;
        ...
        /// <summary>Implicitly converts a single fp value to a double3 vector by converting it to double and assigning it to every component.</summary>
        /// <param name="v">fp to convert to double3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3(fp v) { return new double3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double3 vector constructed from a single fp value by converting it to double and assigning it to every component.</summary>
        /// <param name="v">fp to convert to double3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 double3(fp v) { return new double3(v); }
