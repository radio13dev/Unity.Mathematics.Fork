...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct uint4x2 : System.IEquatable<uint4x2>, IFormattable
    {
        ...
        /// <summary>Constructs a uint4x2 matrix from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint4x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint4x2(fp v)
        {
            this.c0 = (uint4)v;
        ...
        /// <summary>Explicitly converts a single fp value to a uint4x2 matrix by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint4x2(fp v) { return new uint4x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint4x2 matrix constructed from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint4x2 uint4x2(fp v) { return new uint4x2(v); }
