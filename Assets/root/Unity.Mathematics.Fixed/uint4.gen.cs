...
namespace Unity.Mathematics.Fixed
{
    ...
    public partial struct uint4 : System.IEquatable<uint4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint4 vector from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint4(fp v)
        {
            this.x = (uint)v;
        ...
        /// <summary>Explicitly converts a single fp value to a uint4 vector by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint4(fp v) { return new uint4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a uint4 vector constructed from a single fp value by converting it to uint and assigning it to every component.</summary>
        /// <param name="v">fp to convert to uint4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint4 uint4(fp v) { return new uint4(v); }
