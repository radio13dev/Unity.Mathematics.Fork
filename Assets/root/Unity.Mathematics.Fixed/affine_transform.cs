...
namespace Unity.Mathematics.Fixed
{
    ...
    public struct AffineTransform : IEquatable<AffineTransform>, IFormattable
    {
        ...
        /// <returns>The converted AffineTransform.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float4x4(AffineTransform m) { return float4x4(float4(m.rs.c0, fp._0), float4(m.rs.c1, fp._0), float4(m.rs.c2, fp._0), float4(m.t, fp._1)); }
    ...
    public static partial class math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4x4 float4x4(AffineTransform transform) { return float4x4(float4(transform.rs.c0, fp._0), float4(transform.rs.c1, fp._0), float4(transform.rs.c2, fp._0), float4(transform.t, fp._1)); }
